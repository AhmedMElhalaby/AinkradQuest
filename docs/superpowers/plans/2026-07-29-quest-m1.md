...
```json
{
  ...
  "version": "v0.1.0",
  "apiVersion": 8,
  "downloadURL": "https://github.com/AinkradHQ/AinkradQuest/releases/download/v0.1.0/quest.bundle.zip",
  "sha256": "<the sha256 printed by release.sh>",
  "sourceRepo": "AinkradHQ/AinkradQuest",
  ...
  "screenshots": [],
  "links": [{ "title": "Source", "url": "https://github.com/AinkradHQ/AinkradQuest" }]
}
```
