...
enum Log {
    ...
    static let store = Logger(subsystem: subsystem, category: "quest.store")
    static let snapshot = Logger(subsystem: subsystem, category: "quest.snapshot")
    static let board = Logger(subsystem: subsystem, category: "quest.board")
    static let sync = Logger(subsystem: subsystem, category: "quest.sync")
}
